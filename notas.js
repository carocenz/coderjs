...
const products = [
  ...
  {id: 2, name: "trashcan", price: 1000 },
  {id: 5041, name: "fridge", price: 3000 },
  {id: 108, name: "microwave", price: 1500 },
];
...
//const productFilter1 = products.filter(element => element.price > 2500);
//console.log(productFilter1);